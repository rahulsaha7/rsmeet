...
const Signup = ({ regData, setregData, handleRegSubmit,getApiData }) => {
  ...
  const CheckEmail = (e) => {
    ...
    let url = 'http://localhost:9000/login/check';
    getApiData(email,url).then((data) => {
        ...
        data.exist
          ...
          : setemailExist({ ePdisplay: "none", ePmessage: "", ebutton: false });
      ...
      >
        ...
        <section className=" mt-3">
          ...
          <div className="usernameHolder p-3 d-flex justify-content-center">
            <input
              ...
              onInvalid={(e) => {
                e.target.setCustomValidity("Please provide correct mail id");
              }}
              autoComplete="off"
              required=" "
            />
        ...
        <section className=" mt-3">
          ...
          <div className="usernameHolder p-3 d-flex justify-content-center">
            <input
              ...
              value={regData.phone}
              onChange={(event) => {
                setregData({ ...regData, phone: event.target.value });
              }}
              onInvalid={(e) => {
                e.target.setCustomValidity("Phone number is mandatory");
              }}
              autoComplete="off"
              required=" "
            />
        ...
        <section className=" mt-3">
          ...
          <div className="usernameHolder p-3 d-flex justify-content-center">
            <input
              ...
              id="m-password"
              onBlur={(event) => {
                regData.password === regData.mPassword
                  ? setpassMatched({ ...regData, mPdisplay: "none" })
                  : setpassMatched({
                      mPdisplay: "block",
              ...
              value={regData.mPassword}
              onChange={(event) => {
                setregData({ ...regData, mPassword: event.target.value });
              }}
        ...
        <section className="w-100 " style={{ textAlign: "center" }}>
          <button
            ...
            type="submit"
            disabled={passMatched.button || emailExist.ebutton}
          >
